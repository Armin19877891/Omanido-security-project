...
if(!isset($_SESSION['loggedin']) || $_SESSION['loggedin'] !== true || empty($_SESSION['user']['isAdmin'])){
    ...
    <table class="w-full">
        ...
        <?php foreach ($users as $user): ?>
            <tr>
               ...
               <td class="border-b p-2"><a href="transacties.php"><?= htmlspecialchars($user['username'], ENT_QUOTES, 'UTF-8') ?></a></td>
